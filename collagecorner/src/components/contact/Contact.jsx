  ...
  return (
    <div className='contact'>
       <div className="contact-col">
        <h3>Send us a message <MdOutlineMessage/></h3>
        ...
        <ul>
            <li><CiMail/> Contact@admission.co</li>
            <li><BsPhoneFlip/> +1800-180-3433</li>
            <li><MdShareLocation/> Ft-654D , Mumbai , India</li>
       ...
       <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            <button type='submit' className='btn dark-btn'>Submit Now <FaArrowAltCircleRight className="ar" /> </button>  
        </form>
        <span>{result}</span>
       </div>
